public interface GameTree {
    ...
    void addWord(String word);
     ...
     /**
     * Adds many word to the tree, updating its frequency if it already exists. 
     * Treats all words as case-insensitive.
     * Assume the files are already stripped of punctuation.
     * @param word The word to add.
     */
    void addManyWord(String[] word);
    ...
    boolean containsWord(String word);
     ...
     /**
     * Swaps the frequency if they both exist.
     * @param word1 The word to swap for.
     * @param word2 The word to swap for.
     * @return true if the word is swapped in the tree, false otherwise.
     */
    boolean swapFrequency(String word1, String word2);
    ...
    int getFrequency(String word);
     ...
     /**
     * Gets the frequency of a given word and doubles it
     * @param word The word whose frequency is to be retrieved.
     * @return true if doubled and false if word not found in tree.
     */
    boolean doubleFreqency(String word);
